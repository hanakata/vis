...
<ul class="nav nav-tabs nav-justified">
	...
	<li role="presentation" class="active"><a href="pc_info_critical.php">Critical</a></li>
...
while ($row = mysqli_fetch_row($query)) {
   ...
   foreach($cve_list as $cve){
	$query = mysqli_query($link,"SELECT * from cve_list inner join kb_list on cve_list.cve_number = kb_list.cve_number where cve_list.cve_number = '{$cve}' and severity = 'Critical'");
